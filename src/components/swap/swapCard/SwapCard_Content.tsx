...
export default function SwapCard_Content() {
  ...
  return (
    <div className="mt-4 flex-col">
        ...
        <div className="flex-col">
          <div className="flex justify-between">
            ...
            >
              ...
              <div className="ml-2 text-gray-100">{selectedCoin_input}</div>
              <div className="ml-2">
                <svg
                  width="12"
                  height="12"
          ...
          <div className="flex justify-between">
            <div className="w-[calc(100%-130px)] text-2xl">
              <input
                ...
                className="w-full animate-pulse border-none bg-transparent text-3xl outline-none"
                disabled
              />
            </div>
            {/* coinlist */}
            ...
            >
              ...
              <div className="ml-2 text-gray-100">{selectedCoin_out}</div>
              <div className="ml-2">
                <svg
                  width="12"
                  height="12"
      ...
      {/* 汇率 */}
      <div className="relative mt-5  flex items-center rounded-xl bg-indigo-950 bg-opacity-90 px-4 py-2 text-sm text-white">
        {/* inputcoin_icon */}
