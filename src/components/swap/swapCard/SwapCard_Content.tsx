    ...
    <div className="flex-col mt-4">
      ...
      <div className=" bg-indigo-950  bg-opacity-90 rounded-xl p-4 relative">
        <div className="flex-col">
          ...
          {/* 百分比选择 */}
          <div className="flex justify-start gap-7 mt-2 text-sm text-gray-100">
            <div
      ...
      {/* 汇率 */}
      <div className="flex bg-indigo-950  bg-opacity-90 rounded-xl px-4 py-2 relative mt-5 text-sm items-center text-white">
        {/* inputcoin_icon */}
